...
Only requiring some minor changes is unode.cpp.
...
Changes to unode.cpp
----------------------
unode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
