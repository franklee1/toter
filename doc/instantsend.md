...
This mechanism has been integrated into Bitcore-Node-unode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/unodepay/insight-api-unode#web-socket-api](https://github.com/unodepay/insight-api-unode#web-socket-api)
* API: [https://github.com/unodepay/insight-api-unode#instantsend-transactions](https://github.com/unodepay/insight-api-unode#instantsend-transactions)
...
By default, the unode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the unode Core daemon:
