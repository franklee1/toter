    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("unode-light"), QVariant("light"));
    ui->theme->addItem(QString("unode-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("unode-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("unode-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("unode-traditional"), QVariant("trad"));
