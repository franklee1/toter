    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("unode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About unode Core"));
...
All the unode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 unode, 0.1 unode, 1 unode and 10 unode -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://unodepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://unodepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("unode Core is shutting down...") + "<br /><br />" +
