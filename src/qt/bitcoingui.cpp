    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("unode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a unode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and unode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About unode Core"), this);
    aboutAction->setStatusTip(tr("Show information about unode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for unode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your unode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified unode addresses"));
    ...
    openAction->setStatusTip(tr("Open a unode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the unode Core help message to get a list with possible unode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("unode Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("unode Core"); // default title
