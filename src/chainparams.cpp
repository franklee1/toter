...
{
    const char* pszTimestamp = "Unode is created in 2018";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 60; // unode: 1 day
        consensus.nPowTargetSpacing = 120 ; // unode: 2.5 minutes
        ...
        genesis = CreateGenesisBlock(1516619117, 2741808, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000090ea12ce940881edef78d7cfea8c7cc30dc75e85a34fbfcc913459af63c"));
        assert(genesis.hashMerkleRoot == uint256S("0xd0b6a8b41966b2a33b49096a8b68b12cc546f812b6be0e808c9072f46cd35a3b"));

        vSeeds.push_back(CDNSSeedData("45.77.78.72", "104.207.129.122"));
       

        // unode addresses start with 'P'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,55);
        // unode script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        // unode private keys start with '3' or 'p'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,60);
        // unode BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // unode BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // unode BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x0000090ea12ce940881edef78d7cfea8c7cc30dc75e85a34fbfcc913459af63c"))
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffff000000000000000000000000000000000000000000000000000000");
        consensus.nPowTargetTimespan = 120; // unode: 1 day
        consensus.nPowTargetSpacing = 1; // unode: 2.5 minutes
        ...
        // Testnet unode addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet unode script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet unode BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet unode BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet unode BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // unode: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // unode: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
      ...
      genesis = CreateGenesisBlock(1516619117, 2741808, 0x1e0ffff0, 1, 50 * COIN);
        ...
        // Regtest unode addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest unode script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest unode BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest unode BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest unode BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
