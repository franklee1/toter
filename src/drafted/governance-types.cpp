...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "unodeNetwork") type = unodeNetwork;
    if(strType == "unodeNetworkVariable") type = unodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == unodeNetwork) s = "unodeNetwork";
    if(type == unodeNetworkVariable) s = "unodeNetworkVariable";
