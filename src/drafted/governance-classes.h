 ...
 *
 *   // network
 *   CunodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.unode.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CunodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: unodeNetwork
// //   -- signature requirements : Key1(User)
// class CunodeNetworkVariable : public CGovernanceObject
// {
// private:
