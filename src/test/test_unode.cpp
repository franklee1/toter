...
#define BOOST_TEST_MODULE unode Test Suite

#include "test_unode.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_unode_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
